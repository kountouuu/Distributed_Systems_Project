...
public class Subscriber3 {
	...
	public static void main(String[] args) {
		...
		Subscriber s3 = new Subscriber(Subscriber_id, Subscriber_port + Subscriber_id);
		
		s3.register(IP, portToBroker+3);
		
		s3.openSubServer(IP, Subscriber_port + Subscriber_id);
